...
r2.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r3.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r4.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r5.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r6.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r7.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r8.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r9.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r10.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r11.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
...
r12.consequent.append(FuzzyProposition(expert,expert.mfs['low']))
