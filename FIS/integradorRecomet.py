...
# Rules
#r1 = FuzzyRule()
#r1.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['low']),FuzzyProposition(restSimilarity,restSimilarity.mfs['high']))),FuzzyProposition(participation,participation.mfs['insufficient']))) #1
#r1.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['high']))

#r2 = FuzzyRule()
#r2.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['low']),FuzzyProposition(restSimilarity,restSimilarity.mfs['low']))),FuzzyProposition(participation,participation.mfs['insufficient']))) #2
#r2.consequent.append(FuzzyProposition(expert,expert.mfs['high']))

#r3 = FuzzyRule()
#r3.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['high']),FuzzyProposition(restSimilarity,restSimilarity.mfs['low']))),FuzzyProposition(participation,participation.mfs['minimum']))) #3
#r3.consequent.append(FuzzyProposition(correlation,correlation.mfs['high']))

#r4 = FuzzyRule()
#r4.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['low']),FuzzyProposition(restSimilarity,restSimilarity.mfs['high']))),FuzzyProposition(participation,participation.mfs['minimum']))) #4
#r4.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['high']))

#r5 = FuzzyRule()
#r5.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['high']),FuzzyProposition(restSimilarity,restSimilarity.mfs['low']))),FuzzyProposition(participation,participation.mfs['sufficient']))) #1
#r5.consequent.append(FuzzyProposition(correlation,correlation.mfs['high']))
...
#r6.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['high']))

#r7 = FuzzyRule()
#r7.antecedent.append(FuzzyOperator('and',(FuzzyOperator('and',FuzzyProposition(userSimilarity,userSimilarity.mfs['high']),FuzzyProposition(restSimilarity,restSimilarity.mfs['high']))),FuzzyProposition(participation,participation.mfs['sufficient']))) #1
...
r1.consequent.append(FuzzyProposition(expert,expert.mfs['high']))
...
r5.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['high']))
...
def eval(e,p,c):
    expert.current_value = e
    restProfile.current_value = p
    correlation.current_value = c
