...
r1.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r2.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r3.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r7.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r8.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r9.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r10.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r11.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
...
r12.consequent.append(FuzzyProposition(restProfile,restProfile.mfs['low']))
